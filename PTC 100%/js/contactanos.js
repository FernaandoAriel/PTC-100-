...
formulario.addEventListener('submit', function(event) {
 ...
 var manualUsuarioBtn = document.getElementById("manualUsuarioBtn");
 var manualUsuarioLink = document.getElementById("manualUsuarioLink");

 manualUsuarioBtn.addEventListener("click", function() {

   manualUsuarioLink.click();
 });


  var manualTecnicoBtn = document.getElementById("manualTecnicoBtn");
  var manualTecnicoLink = document.getElementById("manualTecnicoLink");
 
  manualTecnicoBtn.addEventListener("click", function() {

    manualTecnicoLink.click();
  });